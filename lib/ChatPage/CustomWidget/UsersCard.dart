...
class UserCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: subtitle.isNotEmpty? Text(subtitle,style: GoogleFonts.jost(color: Colors.black),): Text("Say hi! to your new friend",style: GoogleFonts.jost(color: Colors.deepPurpleAccent[600]),),
